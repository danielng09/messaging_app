...
c1 = Conversation.create(active: true)
c2 = Conversation.create(active: true)
...
Message.create({conversation_id: 1, from_id: 1, to_id: 4, subject: "intro", body: "hello", read: false})
Message.create({conversation_id: 1, from_id: 4, to_id: 1, subject: "RE:intro", body: "hello", read: false})
Message.create({conversation_id: 1, from_id: 1, to_id: 4, subject: "RE:RE:intro", body: "hello", read: false})
Message.create({conversation_id: 2, from_id: 1, to_id: 5, subject: "intro", body: "hello", read: false})
